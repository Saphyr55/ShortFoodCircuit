...
public final class InjectConfiguration {
    ...
    private void configureForRepository() {
        repositoryFactory.getAllRepository().forEach((final var repository) -> Arrays
    ...
    private void configureForComponent() {
        componentFactory.getAllComponents().forEach((final var component) -> Arrays
    ...
    private void configureForController() {
        controllerFactory.getAllControllers().forEach((final var controller) -> Arrays
